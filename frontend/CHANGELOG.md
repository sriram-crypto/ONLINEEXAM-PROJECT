...
- `nouislider` this was used inside SAHASRAPATH PRO React, but Material-UI comes with its own slider component
...
- Added React Hooks
- Added design from SAHASRAPATH React by Creative Tim
- Added features from SAHASRAPATH React by Creative Tim (such as routing system and components)
